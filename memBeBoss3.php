			...
			<section class="col-xs-12 col-sm-12 section1000">
				...
				<form class="form-horizontal" action="" method="post">
					<p>
						...
						<input type="text" name="MEM_NAME" maxlength="8" placeholder="請輸入真實姓名" autofocus>
					</p>
					<p>
						<label for="SI_PHONE"><span class="required">*</span>聯絡電話</label>
						<input type="tel" name="SI_PHONE" pattern="\d{10}" placeholder="輸入格式:034257387">
					</p>
					<p>
