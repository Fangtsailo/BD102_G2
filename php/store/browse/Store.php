...
class Store {
	...
	function __construct($id=0,$name="山下麵包", $storeLogo="default.png", $address="桃園市中壢區中大路300號", $openStartTime=11, $openEndTime=22, $phone="1234567890", $closeDay="1,7", $story="story", $type=0, $banner1="", $banner2="", $banner3="") {
		$this->id = $id;
		$this->name = $name;
