...
<?php 
	...
	echo print_r($GLOBALS["produtsArr"]);
 ?>
<div class="navigator">
	<div class="item">
		<a href=""><p>123</p></a>
...
<div class="screen screen-product">
	...
	<div class="product">
		...
		?>
					<div class="item">
						<div class="image"><img alt="<?php //echo $product[0]; ?>" src="<?php //echo $proPicPath, $product[0]; ?>"></div>
						<div class="describe">
						<h3><?php //echo $product[1]; ?><button id="bread-detail">詳情</button></h3>
	...
	<div class="product-list">
		...
		?>
				<div class="item pointer col-xs-4">
					<img alt="<?php //echo $product[0]; ?>" src="<?php //echo $proPicPath, $product[0]; ?>">
